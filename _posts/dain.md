---
title: "Bringing My Office to a Hackathon"
excerpt: "Bringing 5 computers, a network switch, and an ultrawide monitor to a 48-hour hackathon to build DAIN: a Distributed Agentic Inference Network."
...
For the UQ Computing Society hackathon this year my team built a project called **DAIN**. It stands for **Distributed Agentic Inference Network**.
The core idea behind the project is pooling computing resources, ranging from high-end desktop GPUs to low-power office PCs and laptops into a 
single unified distributed AI cluster. DAIN allows multiple machines to coordinate and distribute model inference and agentic workloads across the local network.
...
Arriving to the event I'd come prepared with 3 former office computers, my personal desktop and laptop, an ultrawide monitor, a 8 port gigabit network switch, and a keyboard and mouse. This was definitely my most absurd set up yet and my team received plenty
of strange looks as we were carting it all into the venue which was a bit funny. 
...
The little Intel NUC installed without a issue. The two office PCs on the other hand, turned into a huge pain. 
...
Saturday morning was spent picking up where I left off on `node.py`. Refining the code to get a good base going for testing 
...
Getting the routing, NAT, and subnets sorted out was tedious and gave me plenty of headaches, but it was rewarding once I could start pinging each machine.
...
![showcase stand](/assets/blog/dain/stand.webp)
